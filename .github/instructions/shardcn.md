...
In _shadcn_ui_ the responsiveness is an important part of the library.
...
In Tailwind CSS, it's common to say that _sm_ is not for small screens, but will target also the largest sizes if you don't provide a larger breakpoint.
