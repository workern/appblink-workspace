...
/// ShopOwnerRecord model matching TypeScript ShopOwnerRecord interface
class ShopOwnerRecord {
  final String? id;
  final String name;
  ...
  factory ShopOwnerRecord.fromJson(Map<String, dynamic> json) {
    try {
      return ShopOwnerRecord(
      ...
      debugPrint('Error parsing ShopOwnerRecord: $e');
      return ShopOwnerRecord(
        id: (json['id'] as dynamic)?.toString() ?? '',
        name: _safeString(json['name']),
        contactNumber: _safeString(json['contactNumber']),
