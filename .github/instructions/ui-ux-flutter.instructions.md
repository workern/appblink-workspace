...
Take help from tools/github/ui-ux-pro-max-skill/.claude/skills/ui-ux-pro-max/data/{app-interface.csv or ui-reasoning.csv or ux-guidelines.csv or icons.csv or design.csv} when creating/updating UI of any screen or widget.,
